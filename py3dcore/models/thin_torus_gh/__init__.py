...
from py3dcore.models.thin_torus_gh.propagation import p


class ThinTorusGH3DCOREModel(Toroidal3DCOREModel):
    ...
    def __init__(self, launch, runs, use_gpu=False, **kwargs):
        ...
        parameters = kwargs.pop("parameters", thin_torus_gh_parameters)
    ...
    def default_parameters(cls):
        return dict(thin_torus_gh_parameters)


thin_torus_gh_parameters = {
    "cme_launch_offset": {
        "index": 0,
        "name": "launch time",
        "distribution": "fixed",
