...
from py3dcore.models.ttghv2.coordinates import g, f
from py3dcore.models.ttghv2t.magfield import h
from py3dcore.models.ttghv2.propagation import p


class TTGHv2T(Toroidal3DCOREModel):
    """Implements the thin torus gold-hoyle (v2) 3DCORE model with T factor.
    ...
    def __init__(self, launch, runs, **kwargs):
        """Initialize the thin torus gold-hoyle (v2) 3DCORE model.
        ...
        super(TTGHv2T, self).__init__(
            launch, funcs, parameters, sparams_count=5, runs=runs, **kwargs
        )

    @classmethod
    def default_parameters(cls):
        path = os.path.join(os.path.dirname(py3dcore.__file__), "models/ttghv2t/parameters.json")
