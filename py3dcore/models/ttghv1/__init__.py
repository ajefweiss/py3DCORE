...
from py3dcore.models.ttghv1.coordinates import g, f
from py3dcore.models.ttghv1.magfield import h
from py3dcore.models.ttghv1.propagation import p


class TTGHv1(Toroidal3DCOREModel):
    """Implements the thin torus gold-hoyle (v1) 3DCORE model.
    ...
    def __init__(self, launch, runs, **kwargs):
        ...
        super(TTGHv1, self).__init__(
            launch, funcs, parameters, sparams_count=5, runs=runs, **kwargs
        )

    @classmethod
    def default_parameters(cls):
        path = os.path.join(os.path.dirname(py3dcore.__file__), "models/ttghv1/parameters.json")
